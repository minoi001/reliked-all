...
export async function getProductsInCollection() {
  ...
  const response = await GraphQLRequest(query, input, 'getProductsInCollection');

  const allProducts = response.collection.products.edges ? response.collection.products.edges : response;
...
export async function getAllProducts() {
  ...
  const slugs = response.collection.products.edges ? response.collection.products.edges : [];
