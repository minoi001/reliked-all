...
const FeaturedCollections = () => {
  return (
    <div className="w-full h-auto flex justify-center relative mt-12">
      <div className="container h-full left-0  ml-0 absolute bg-cream"></div>
      <div className=" max-w-7xl container h-full my-8 static p-0 py-0  mx-auto flex flex-col justify-around lg:flex-row">
